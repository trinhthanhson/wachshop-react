...
const AllBrand = () => {
  ...
  const handleAddBrand = async () => {
    try {
      ...
      const response = await axios.post(
        'https://watchshop-backend.onrender.com/api/staff/brand/add',
        {
  ...
  const handleUpdateBrand = async (brandId) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://watchshop-backend.onrender.com/api/staff/brand/${brandId}/update`,
        {
          brand_name: newBrandName
        },
        {
  ...
  const handleDeleteBrand = async (brandId) => {
    ...
    if (confirmDelete) {
      try {
        await axios.delete(
          `https://watchshop-backend.onrender.com/api/staff/brand/${brandId}/delete`,
          {
            headers: {
              Authorization: `Bearer ${token}`
            }
