...
const AllCategory = () => {
  ...
  const handleAddCategory = async () => {
    try {
      ...
      const response = await axios.post(
        'https://watchshop-backend.onrender.com/api/staff/category/add',
        {
  ...
  const handleUpdateCategory = async (categoryId) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://watchshop-backend.onrender.com/api/staff/category/${categoryId}/update`,
        {
          category_name: newCategoryName
        },
        {
  ...
  const handleDeleteCategory = async (categoryId) => {
    ...
    if (confirmDelete) {
      try {
        await axios.delete(
          `https://watchshop-backend.onrender.com/api/staff/category/${categoryId}/delete`,
          {
            headers: {
              Authorization: `Bearer ${token}`
            }
